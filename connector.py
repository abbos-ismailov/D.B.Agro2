...
class ConnectorQuery(object):
        ...
        if self._action == "SELECT":
            ...
            if self._order:
                if self._reverse:
                    ...
                    _query += f" ORDER BY {self._order} ASC"
    ...
    def order_by(self, column, reverse = False):
        self._order = column
    ...
    def count(self, name = ""):
        if not name:
            ...
            self._group_by_args["count"].append(name)
        return self
    ...
    def copy(self):
        ...
        new_copy._reverse = self._reverse
